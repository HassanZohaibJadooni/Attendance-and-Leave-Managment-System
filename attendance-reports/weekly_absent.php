...
<div class="content-wrapper p-4">
    ...
    <div class="col d-flex justify-content-between align-items-center mb-3">
        ...
        <h2 class="text-2xl font-semibold m-0" id="chartTitle"><?= $default_title; ?></h2>
        <div class="d-flex gap-2">
            <button class="btn btn-sm px-4 py-1 btn-outline-danger rounded-pill shadow-sm active-chart-button" id="absent_lastweek"
                data-url="lweek_absent.php"
                data-title="Last Week Absent Chart"
            ...
            <button class="btn btn-sm px-4 py-1 btn-outline-success rounded-pill shadow-sm" id="present_lastweek"
                data-url="lweek_present.php" data-title="Last Week Present Chart"
            ...
            <button class="btn btn-sm px-4 py-1 btn-outline-warning rounded-pill shadow-sm" id="leave_lastweek"
                data-url="lweek_leave.php"
                data-title="Last Week Leave Chart"
...
<script>
    am5.ready(function() {
                ...
                success: function(response) {
                    ...
                    var series = chart.series.push(
                        am5xy.ColumnSeries.new(root, {
                            name: title.replace('Last Week ', ''), // Use part of title as series name
                            xAxis: xAxis,
                            yAxis: yAxis,
        ...
        // default 
        loadChart("<?php echo $default_url; ?>","<?php echo $default_title; ?>","<?php echo $default_value_field; ?>","<?php echo $default_y_axis_title; ?>","<?php echo $default_tooltip_text; ?>","<?php echo $default_button_id; ?>");
